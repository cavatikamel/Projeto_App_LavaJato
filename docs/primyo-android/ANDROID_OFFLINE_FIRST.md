...
Consolidar a leitura oficial de offline-first para o Android do LavaPrime depois da auditoria `LP-ANDROID-001`.
...
- nao ha evidência executada de retomada real apos reinstall, migration ou troca de dispositivo.
